...
activities = {
    ...
    # Artistic activities
    "Art Club": {
        "description": "Explore drawing, painting, sculpture, and gallery exhibits",
    ...
    "Drama Club": {
        ...
        "max_participants": 30,
        "participants": ["logan@mergington.edu", "quinn@mergington.edu"]
    },
    ...
    "Science Olympiad": {
        "description": "Hands-on science competitions and project workshops",
